/**
 * Parses an array of reviews and returns an array of parsed review objects.
 * @param {Array} reviews - The array of reviews to parse. Each review is expected to be an array with specific nested structures.
 * @returns {Promise<Array>} A promise that resolves to an array of parsed review objects.
 *
 */
